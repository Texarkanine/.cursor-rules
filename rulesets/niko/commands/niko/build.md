...
- **Level 1**: After implementation complete, proceed to `/reflect` command for task review.
- **Level 2+**: After implementation complete, proceed to `/qa` command for post-build semantic review.

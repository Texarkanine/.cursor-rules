...
- **Resource format**: Plain Markdown (`.md`) with no frontmatter — loaded by explicit path from skills or other resources.
...
- Resource files: `.md` extension with no frontmatter, live under `rulesets/niko/skills/niko/resources/**/*.md` (sources) and sync into `.cursor/skills/shared/niko/resources/**/*.md`. Loaded by explicit path from skills and other resources.

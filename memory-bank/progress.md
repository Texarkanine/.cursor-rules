...
- Design decision resolved via `/niko-creative` prior to this task
- Complexity: Level 2 (Simple Enhancement)
- Scope: 4 rulesets template files + 5 existing archive documents
- Next: Plan → Build → QA → Reflect → Archive
